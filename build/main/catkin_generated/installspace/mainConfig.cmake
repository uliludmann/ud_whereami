...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/ulrich/catkin_ws/src/main)
  set(main_DEVEL_PREFIX /home/ulrich/catkin_ws/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/ulrich/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ulrich/catkin_ws/install/${idir}'.  ${_report}")
    endif()
